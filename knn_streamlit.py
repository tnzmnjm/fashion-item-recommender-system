...
selected_product = st.selectbox(label='Please choose/search for a product :', options=df_random.productDisplayName.values)
selected_id = df_random[df_random.productDisplayName == selected_product]["id"].values[0]
...
if selected_product is not None:
    ...
    if selected_id > 0:
        ...
        # recommended product will have the same gender unless it's unisex which will be everything

        st.subheader(f'Substitutable Products')
        st.subheader(f'Please choose your required filters')
